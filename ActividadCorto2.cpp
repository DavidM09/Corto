 ...
 return 1;
    ...
    switch (categoria){
        ...
        switch (stud){                                                // resultados de las compras
            ...
            case 1:// la operacion para tener el resultado
            ...
            case 2:// la operacion para tener el resultado
            ...
            case 3:// la operacion para tener el resultado
            ...
            cout << "ingrese un dato correcto" << endl;       //en caso de que ingrese un dato incorrecto 
        ...
        cin >> pro;
         ...
         switch (pro){                                                  //resultados de las compras
            ...
            case 3:
            cout <<"Estacion de Trabajo - su total es de $1800" << endl;         // la operacion para tener el resultado
            total = (mny - 1800);
